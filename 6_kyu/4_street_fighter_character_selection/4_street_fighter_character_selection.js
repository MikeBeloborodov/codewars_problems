...
const case1 = streetFighterSelection(fighters, [0, 0], ["up", "left", "right", "left", "left"]);
["Ryu", "Vega", "Ryu", "Vega", "Balrog"].forEach((item, index) => {
    if (item !== case1[index])
        throw new Error("Test failed for case1");
});
const case2 = streetFighterSelection(fighters, [0, 0], ["left", "left", "left", "left", "left", "left", "left", "left"]);
console.log(case2);
[
    "Vega",
    "Balrog",
    ...
    if (item !== case2[index])
        throw new Error("Test failed for case2");
});
